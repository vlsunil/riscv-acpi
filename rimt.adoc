...
* Bit 0: ATS Enabled
** 0: ATS is not enabled for the devices in this mapping
** 1: ATS is enabled for the devices in this mapping

* Bit 1: PRI Enabled
** 0: PRI is not enabled for the devices in this mapping
** 1: PRI is enabled for the devices in this mapping
