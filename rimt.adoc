...
Below mapping tables are just for example how software would see the mapping array. The example
mapping table is not intended to optimal.

.PCIe RC device ID mapping structure for device_id width = 7, Memory mapped IOMMU
|===
|*Source ID Base (RID)* | *Desination  Device ID Base* | *Number of IDs* | *Destination IOMMU*
|0x0000 (0x0000-0x000F) | 0x0 | 0x10 | IOMMU0
|0x0100 (0x0100-0x010F) | 0x10 | 0x10 | IOMMU0
|0x0010 | 0x20 | 0x1 | IOMMU0
|0x0020 | 0x30 | 0x1 | IOMMU0
|===

.Platform device ID mapping structure for device_id width = 7, Memory mapped IOMMU
|===
|*Source ID Base* | *Desination  Device ID Base* | *Number of IDs* | *Destination IOMMU*
|0x0000 | 0x40 | 0x1 | IOMMU0
|===

.PCIe RC device ID mapping structure for device_id width = 7, IOMMU as a PCIe device with BDF 0x0010
|===
|*Source ID Base (RID)* | *Desination  Device ID Base* | *Number of IDs* | *Destination IOMMU*
|0x0000 (0x0000-0x000F) | 0x0 | 0x10 | IOMMU1(0x0010)
|0x0100 (0x0100-0x010F) | 0x10 | 0x10 | IOMMU1(0x0010)
|0x0020 | 0x20 | 0x1 | IOMMU1(0x0010)
|===
